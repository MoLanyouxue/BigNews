...
/* 
添加$.ajaxSetup配置
    1、$.ajasSetup():为所有的Ajax请求设置默认值
    2、beforeSend(xhr):发送请求前运行的函数 。（这个方法可以根据后台需要设置一些固定的请求头）
*/
$.ajaxSetup({
    // 在发送之前，给所有的请求都设置请求头（从localStorage中读取token)
    beforeSend(xhr){
        xhr.setRequestHeader('Authorization',localStorage.getItem('token'));
    },
    error(xhr,status,error){//请求错误的时候回进入这个方法进行拦截
